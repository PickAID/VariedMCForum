...
is_forbidden_deploy_path() {
  case "$1" in
    ...
    .deployignore|.gitignore|config.json|config.local.json|docker-compose.local-mongo.yml)
      return 0
      ;;
    scripts/local-mongo.mjs|scripts/local-nodebb.mjs|scripts/sync-nodebb-ui-state.mjs|scripts/verify-local-runtime.mjs|scripts/update-nodebb-docs.sh|scripts/sync-nodebb-extension-state.mjs|scripts/verify-production-extension-state-sync.sh)
      return 0
      ;;
